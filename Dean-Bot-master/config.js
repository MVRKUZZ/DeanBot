const ownerNumber = ["5588996990290@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5588996990290' 
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5588996990290:+55 88 9699-0290\n' 
+ 'END:VCARD'
